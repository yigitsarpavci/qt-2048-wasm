...
static constexpr auto qt_meta_stringdata_CLASSTileWidgetENDCLASS = QtMocHelpers::stringData(
    "TileWidget"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSTileWidgetENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSTileWidgetENDCLASS_t qt_meta_stringdata_CLASSTileWidgetENDCLASS = {
    {
        QT_MOC_LITERAL(0, 10)   // "TileWidget"
    },
    "TileWidget"
};
