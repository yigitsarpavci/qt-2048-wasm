// Implementation of the 2048 game engine logic.
...
// Resets the game state, clearing the grid, score, and history.
...
// Main move logic. Handles coordinate rotation, merging, and state updates.
...
// Spawns new tiles in random available empty cells.
...
// Saves the current game state into the history stack for undo support.
void GameEngine::saveSnapshot() {
    ...
    m_history.push_back({m_grid, m_score, m_nextId});
}
